...
export const MonthlyLineChart = ({ data }) => (
  <ResponsiveContainer width="100%" height={280}>
    <LineChart data={data} margin={{ top: 5, right: 20, left: 10, bottom: 5 }}>
      ...
      <Line type="monotone" dataKey="expense" stroke="#f43f5e" strokeWidth={2.5} dot={{ fill: '#f43f5e', r: 4 }} name="Gastos" />
    </LineChart>
  </ResponsiveContainer>
);
...
export const StackedBarChart = ({ data }) => (
  <ResponsiveContainer width="100%" height={280}>
    <BarChart data={data} margin={{ top: 5, right: 20, left: 10, bottom: 5 }}>
      ...
      <Bar dataKey="expense" stackId="a" fill="#f43f5e" radius={[4, 4, 0, 0]} name="Gastos" />
    </BarChart>
  </ResponsiveContainer>
);
