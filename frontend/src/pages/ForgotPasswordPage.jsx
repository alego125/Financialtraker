    ...
    <div className="min-h-screen bg-surface flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-display font-bold text-[var(--text)]">Olvidé mi contraseña</h1>
        </div>
        ...
        <div className="card p-5 sm:p-7 space-y-5">
          <div className="text-center">
            ...
            <h2 className="font-display font-bold text-[var(--text)] mb-2">Recuperación manual</h2>
            <p className="text-[var(--muted)] text-sm leading-relaxed">
              Para restablecer tu contraseña, enviá un email al administrador solicitando el reseteo de tu cuenta.
            </p>
          </div>

          <div className="bg-surface3 border border-[var(--border2)] rounded-xl p-4 space-y-2">
            <p className="text-xs font-display font-semibold text-[var(--subtle)] uppercase tracking-wider">Email del administrador</p>
            <a href="mailto:alejandro.gomez969@gmail.com?subject=Solicitud%20de%20reseteo%20de%20contraseña%20-%20FinancialTracker"
              className="text-accent-light font-mono text-sm hover:text-[var(--text)] transition-colors break-all">
              alejandro.gomez969@gmail.com
            </a>
          </div>

          <div className="bg-surface3 border border-[var(--border2)] rounded-xl p-4">
            <p className="text-xs font-display font-semibold text-[var(--subtle)] uppercase tracking-wider mb-2">Modelo de email</p>
            <p className="text-[var(--muted)] text-xs leading-relaxed italic">
          ...
          <div className="pt-2 text-center border-t border-[var(--border)]">
            <Link to="/login" className="text-accent-light hover:text-[var(--text)] text-sm font-medium transition-colors">
