    ...
    <div style={{
      ...
      <div style={{position:'relative',width:'100%',maxWidth:'400px'}}>
        <div style={{textAlign:'center',marginBottom:'32px'}}>
          <img src={logoUrl} alt="FinancialTracker" style={{width:'64px',height:'64px',borderRadius:'20px',objectFit:'cover',boxShadow:'0 8px 32px rgba(232,160,32,0.3)',margin:'0 auto 16px',display:'block'}} />
          <h1 style={{fontSize:'2rem',fontFamily:'Syne, sans-serif',fontWeight:800,color:'var(--text)',margin:'0 0 6px'}}>Bienvenido</h1>
          <p style={{fontSize:'0.875rem',color:'var(--muted)',margin:0}}>Ingresá a tu cuenta para continuar</p>
        </div>
        ...
        <div style={{background:'var(--surface2)',border:'1.5px solid var(--border)',borderRadius:'24px',padding:'28px',boxShadow:'var(--card-shadow2)'}}>
          ...
          <form onSubmit={handleSubmit} style={{display:'flex',flexDirection:'column',gap:'16px'}}>
            ...
            <div style={{textAlign:'right',marginTop:'-8px'}}>
              <Link to="/forgot-password" style={{fontSize:'0.8rem',color:'var(--gold)',textDecoration:'none',fontWeight:600,fontFamily:'Syne, sans-serif'}}>
          ...
          <div style={{marginTop:'20px',paddingTop:'20px',borderTop:'1.5px solid var(--border)',textAlign:'center'}}>
            <p style={{fontSize:'0.875rem',color:'var(--muted)',margin:0}}>
              ¿No tenés cuenta?{' '}
              <Link to="/register" style={{color:'var(--gold)',fontWeight:700,textDecoration:'none',fontFamily:'Syne, sans-serif'}}>
                Registrate
              </Link>
            </p>
          </div>
